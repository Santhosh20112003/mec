...
function Medical() {
  ...
  const stats = [
    ...
    { number: "90,000+", label: "Annual Graduates", subtext: "Medical Professionals" },
    { number: "250K+", label: "Hospital Beds", subtext: "For Clinical Training" },
  ...
  const researchImages = {
    ...
    collab: "https://images.unsplash.com/photo-1576086213369-97a306d36557?ixlib=rb-4.0.3&auto=format&fit=crop&q=80&w=2068"
  };
  ...
  const programImages = {
    ...
    specialty: "https://images.unsplash.com/photo-1559757175-7b21e5afae2a?ixlib=rb-4.0.3&auto=format&fit=crop&q=80&w=2073"
  };
    ...
    <div className="bg-gray-50 min-h-screen">
      {/* Hero Section with Image Background */}
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center px-4 text-center">
          ...
          >
            World-class medical education combining ancient wisdom with modern healthcare excellence
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-8">
                ...
                <div className="p-6 sm:p-8">
                  <div className="prose prose-lg max-w-none">
                    <div className="bg-red-50 rounded-xl p-5 border-l-4 border-[#9f0712] mb-6">
                      <h3 className="text-[#9f0712] font-semibold text-lg mb-2">Global Recognition</h3>
                      <p className="text-gray-700">
                        Indian medical education is recognized worldwide, with graduates practicing in prestigious institutions across the globe. The curriculum follows international standards while incorporating India's rich medical heritage through AYUSH integration.
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-8">
                      <div className="bg-red-50 rounded-xl p-5 border-t-4 border-[#9f0712]">
                        ...
                        <h3 className="text-[#9f0712] font-semibold text-xl mb-2">WHO Recognition</h3>
                        <p className="text-gray-700">All major medical colleges are recognized by the World Health Organization and listed in the World Directory of Medical Schools.</p>
                      </div>
                      ...
                      <div className="bg-red-50 rounded-xl p-5 border-t-4 border-[#9f0712]">
                        ...
                        <h3 className="text-[#9f0712] font-semibold text-xl mb-2">Clinical Exposure</h3>
                        <p className="text-gray-700">Students gain extensive hands-on experience through exposure to diverse patient cases and advanced medical conditions.</p>
                      </div>
                      ...
                      <div className="bg-red-50 rounded-xl p-5 border-t-4 border-[#9f0712]">
                        ...
                        <h3 className="text-[#9f0712] font-semibold text-xl mb-2">Research Focus</h3>
                        <p className="text-gray-700">Strong emphasis on research with collaborations with international institutions and pharmaceutical companies.</p>
                      </div>
                    </div>
                    ...
                    <div className="my-8 bg-[#9f0712] text-white p-6 rounded-xl">
                      ...
                      <ul className="list-disc pl-5 space-y-2">
                        <li>Comprehensive curriculum following global standards</li>
                        <li>Integration of traditional medicine with modern practices</li>
                        <li>Extensive clinical exposure in diverse healthcare settings</li>
            ...
            {activeSection === "programs" && (
              ...
              >
                <div className="p-6 sm:p-8">
                  <h2 className="text-2xl font-bold text-[#9f0712] mb-6">Medical Programs</h2>
                      ...
                      <ul className="space-y-3">
                        ...
                        <li className="text-gray-800 flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">Super-specialization programs</p>
                          </div>
                        </li>
                      </ul>
                    </div>
                ...
                <div className="grid grid-cols-1 items-end md:grid-cols-2 gap-6 p-6">
                  <div className="space-y-6">
                    ...
                    <div className="bg-red-50 rounded-lg p-4">
                      <h3 className="text-lg font-semibold text-[#9f0712] mb-2">Hospital Facilities</h3>
                    ...
                    <div className="bg-red-50 rounded-lg p-4">
                      <h3 className="text-lg font-semibold text-[#9f0712] mb-2">Research Facilities</h3>
                      <ul className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <img src={infrastructureImages.lab1} alt="Anatomy Lab" className="rounded-lg h-48 w-full object-cover"/>
                    <img src={infrastructureImages.lab2} alt="Simulation Center" className="rounded-lg h-48 w-full object-cover"/>
                    <img src={infrastructureImages.lab3} alt="Operation Theater" className="rounded-lg h-48 w-full object-cover"/>
                    <img src={infrastructureImages.lab4} alt="Medical Library" className="rounded-lg h-48 w-full object-cover"/>
                  </div>
                </div>
              </motion.div>
            )}
            ...
            {activeSection === "clinical" && (
              ...
              >
                <div className="p-6">
                  <h2 className="text-2xl font-bold text-[#9f0712] mb-6">Clinical Training Excellence</h2>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-red-50 rounded-lg p-4">
                      ...
                      <h3 className="text-lg font-semibold text-[#9f0712] mb-2">Patient Exposure</h3>
                      <p className="text-gray-700">
                        Students gain experience with diverse patient cases, from common ailments to rare conditions, in both urban and rural healthcare settings.
                      </p>
                    </div>
                    ...
                    <div className="bg-red-50 rounded-lg p-4">
                      ...
                      <h3 className="text-lg font-semibold text-[#9f0712] mb-2">Practical Skills</h3>
                      <p className="text-gray-700">
                        Hands-on training in diagnostic procedures, surgical techniques, and patient care under expert supervision.
                      </p>
                    </div>
                    ...
                    <div className="bg-red-50 rounded-lg p-4">
                      ...
                      <h3 className="text-lg font-semibold text-[#9f0712] mb-2">Rural Healthcare</h3>
                      <p className="text-gray-700">
                        Mandatory rural postings provide unique exposure to primary healthcare challenges and community medicine.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {activeSection === "research" && (
              ...
              >
                <div className="p-6">
                  <h2 className="text-2xl font-bold text-[#9f0712] mb-6">Research and Innovation</h2>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-red-50 rounded-lg p-6">
                      <h3 className="text-xl font-semibold text-[#9f0712] mb-4">Research Areas</h3>
                      <ul className="space-y-2">
                    ...
                    <div className="bg-red-50 rounded-lg p-6">
                      <h3 className="text-xl font-semibold text-[#9f0712] mb-4">Collaborations</h3>
                      <ul className="space-y-2">
