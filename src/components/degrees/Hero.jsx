...
function Hero() {
  return (
    <section className="text-gray-900 body-font">
      <div className="max-w-7xl mx-auto flex px-5 md:px-12 md:py-24 py-12 md:flex-row flex-col items-center">
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-2 lg:grid-cols-3 max-w-xl gap-3 w-full justify-center">
            <HashLink
              onClick={() => {
                window.scrollTo({ top: 0, behavior: "smooth" });
              }}
              to="/engineering"
              className="inline-flex justify-center text-white bg-[#800000] border-0 py-2 px-6 focus:outline-none hover:bg-[#600000] rounded-full text-lg"
            >
              Engineering
            </HashLink>
            <HashLink
